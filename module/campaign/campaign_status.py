...
if server.server != 'jp':
    ...
    OCR_COIN_LIMIT = Digit(OCR_COIN_LIMIT, name='OCR_COIN_LIMIT', letter=(201, 201, 201), threshold=128)
    ...
    def _get_oil(self):
        ...
        if color_similar(color, OCR_OIL_CHECK.color):
            ...
            if server.server != 'jp':
                ...
                ocr_oil = Digit(OCR_OIL, name='OCR_OIL', letter=(201, 201, 201), threshold=128)
                ocr_oil_limit = Digit(OCR_OIL_LIMIT, name='OCR_OIL_LIMIT', letter=(201, 201, 201), threshold=128)
